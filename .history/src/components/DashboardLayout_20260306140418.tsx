  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-[#84041c]">
      ...
      <div className="flex-1 flex flex-col min-w-0 max-w-full">
        <header className="sticky top-0 z-20 flex items-center justify-between gap-2 px-3 py-3   backdrop-blur-xl border-b border-slate-200/80 dark:border-gray-800 lg:hidden">
