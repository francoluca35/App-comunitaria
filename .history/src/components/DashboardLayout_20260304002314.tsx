  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-gray-950">
      ...
      <div className="flex-1 flex flex-col min-w-0 max-w-full">
        <header className="sticky top-0 z-20 flex items-center gap-3 px-4 py-3 bg-white/90 dark:bg-gray-950/90 backdrop-blur-xl border-b border-slate-200/80 dark:border-gray-800 lg:hidden">
          <button
            type="button"
