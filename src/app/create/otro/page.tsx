...
function CreateOtroForm() {
  ...
  useEffect(() => {
    ...
    setCategory((prev) => {
      if (presetCategory && postCategories.some((c) => c.slug === presetCategory)) {
        return presetCategory
      }
      if (prev && postCategories.some((c) => c.slug === prev)) return prev
      return postCategories[0].slug
    })
  }, [postCategories, presetCategory])
    ...
    <DashboardLayout>
      <div className="max-w-md mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-xl font-bold text-slate-900 dark:text-white">Otra publicación</h1>
        </div>
